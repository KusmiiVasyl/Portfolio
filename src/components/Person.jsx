...
export const Person = () => {
  ...
  return (
    <section id='home' className='lg:h-[85vh] flex items-center bg-cyan-900 lg:bg-cover
      ...
      <div className='container mx-auto h-full'>
        <div className='flex flex-col lg:flex-row items-center h-full pt-8'>
          <div className="flex-1 flex flex-col items-center lg:items-start">
            ...
            <h1 className='text-4xl text-cyan-200 leading-[44px] md:text-5xl md:leading-tight lg:text-7xl
